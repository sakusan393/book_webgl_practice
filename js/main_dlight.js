onload = function(){
    ...
    console.log(gl.getAttribLocation(prg, 'texCoord'));
    ...
    var st_vbo = create_vbo(st);


    // VBO を登録する
    set_attribute([pos_vbo, nor_vbo, col_vbo,st_vbo], attLocation, attStride);
