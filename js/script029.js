...
onload = function(){
	...
	// 球体モデル
	var sphereData    = sphere(20, 20, 2.0);
	...
	uniLocation[6] = gl.getUniformLocation(prg, 'texture2');
	...
	// テクスチャ関連
	var texture = null;
	create_texture('images/texturesazabycokpit_n.png');
	var texture2 = null;
	create_texture2('images/texturesazabycokpit.jpg');
	...
	function create_texture2(source){
		// イメージオブジェクトの生成
		var img = new Image();
