;(function() {
	...
	var drawFrame = function() {
		...
		mat4.frustum(proj_mat, -2, 2, -1, 1, 3, 100);
		// 移動回転行列の生成
		var mv_mat = mat4.create();
		mat4.translate(mv_mat, mv_mat, [ Math.cos(frame/100)*3, Math.sin(frame/100)*-3, Math.sin(frame/100)*1 * 3 -10]);
		mat4.rotate(mv_mat, mv_mat, frame * 0.01, [0.2, 1, 0.5]); // 軸[0, 1, 0]で回転
